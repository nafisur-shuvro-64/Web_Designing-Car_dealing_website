...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="images/carlogo2s.jpg" />
    <style type="text/css">
        .div_center
        {
            text-align: center;
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="div_center">
                    <h1 class="font_size">Update Car Info</h1>
                    ...
                    <div class="div_design">
                        ...
                        <input class="text_color" type="number" name="dis_price" placeholder="Write a Discount Price if applicable" value="{{$product->discount_price}}">
                    </div>
